...
from .views import (add_review, category_detail, chat_view, create_listing,
                    ...
                    make_offer, signup, start_conversation, start_direct_user_chat, toggle_favorite,
                    ...
                    terms_view, privacy_view, cookies_view, legal_notice_view, save_marketing_consent,
                     ...
                     delete_listing, support_view, help_center_view, safety_rules_view, selling_tips_view, chat_poll)
...
urlpatterns = [
    ...
    path("mensajes/directo/<str:username>/", start_direct_user_chat, name="start_direct_chat"),
